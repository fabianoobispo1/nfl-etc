...
export function Podcast() {
  ...
  return (
    <main className="min-h-screen bg-gray-100">
      ...
      {/* Último Episódio */}
      <section className="container mx-auto my-8 px-4 " ref={episodeRef}>
        ...
        {loading ? (
          <div className="flex flex-col gap-4 rounded-lg bg-white p-4 shadow-md md:flex-row md:p-6">
            <div className="">
              <Image
                src="/carousel-1.svg" // Substitua com o link da imagem do episódio
          ...
          <div className="flex flex-col gap-4 rounded-lg bg-white p-4 shadow-md md:flex-row md:p-6">
            <div className="">
              <Image
                src={episodes[0].image} // Substitua com o link da imagem do episódio
                alt="Capa do último episódio"
                width={500}
                height={300}
            ...
            <div className="mt-4">
              ...
              <p className="mt-4 text-gray-700">
                {/* Exibição do snippet com expansão */}
                <p
